...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="reg-db.php" method="post">
            ...
            <input type="email" name="email" class="form-control" id="pass" placeholder="E-mail"><br>
            <input type="password" name="pass" class="form-control" id="email" placeholder="Пароль"><br>
